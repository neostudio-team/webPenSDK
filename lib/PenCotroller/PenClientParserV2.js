  ...
  PenDotEvent(cmd, pk) {
    ...
    if (!this.penSettingInfo.HoverMode && !this.state.IsStartWithDown) {
      if (!this.state.IsStartWithPaperInfo) {
        ...
        let errorDot = Dot.MakeDot(this.current, x, y, force, Dot.DotTypes.PEN_ERROR, this.state.PenTipType, this.state.mPenTipColor, angel);
    ...
    if (this.penSettingInfo.HoverMode && !this.state.IsStartWithDown && this.state.IsStartWithPaperInfo) {
      dot = Dot.MakeDot(this.current, x, y, force, Dot.DotTypes.PEN_HOVER,  this.state.PenTipType, this.state.mPenTipColor, angel);
